...
{ 
    ...
    { 
        int pivot = dizi[high];  //dizinin ilk deerini pivot alırsın
        int i = (low-1); // en düşük elamanın indisi i olarak alınır
        for (int j=low; j<high; j++) //j yi en düşük deger olarak al ve j en buyuk egerden kuçuk oldugu sürece jyi arttır
